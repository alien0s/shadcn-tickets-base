...
import type { LucideIcon } from "lucide-react"; // ✅ tipagem correta para ícones lucide

type Metric = {
  label: string;
  value: number;
  icon: LucideIcon; // ✅ mais flexível e correto
  change: string;
  changeTone: "up" | "down";
  headline: string;
  body: string;
      ...
      <CardHeader className="p-6 pb-4 md:p-4 md:pb-3">
        <div className="flex items-start justify-between gap-3">
          ...
          <span
            ...
            aria-label={`Variação ${metric.changeTone === "up" ? "positiva" : "negativa"}: ${metric.change}`} // ✅ a11y sem mudar UI
          >
